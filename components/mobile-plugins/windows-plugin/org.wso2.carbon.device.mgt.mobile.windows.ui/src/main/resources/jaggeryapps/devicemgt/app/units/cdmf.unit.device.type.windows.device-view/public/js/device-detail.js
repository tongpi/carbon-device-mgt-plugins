    ...
    function loadApplicationsList() {
        ...
        $.template("application-list", applicationListingTemplate, function (template) {
            ...
            invokerUtil.get(
                    ...
                    if (jqXHR.status == 200 && data) {
                        ...
                        if (data.length > 0) {
                            ...
                            $("#applications-list-container").
                                html("<div class='message message-info'><h4><i class='icon fw fw-info'></i>未发现应用程序。</h4>" +
                                "<p>请稍后尝试刷新列表。</p></div>");
                        }
                    }
                },
                ...
                function () {
                    $("#applications-list-container").
                        html("<div class='panel-body'><br><p class='fw-warning'>&nbsp;加载应用程序列表失败。 请稍后尝试刷新列表。<p></div>");
                });
        });
    }
                        ...
                        if (jqXHR.status == 200 && data) {
                            ...
                            if (data["active"] == true) {
                                ...
                                invokerUtil.get(
                                    ...
                                    function () {
                                        $("#policy-list-container").
                                            html("<div class='panel-body'><br><p class='fw-warning'>加载策略合规性相关数据不成功。 请尽量刷新数据。<p></div>");
                                    }
                                );
                            }
                        }
